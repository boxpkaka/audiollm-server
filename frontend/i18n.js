...
(() => {
  ...
  const EN = {
    ...
    'asr.hotword.title': 'Global hotword pool',
    'asr.hotword.tip': 'Manage the Triton hotword pool used by final ASR segments.',
    'asr.hotword.lang': 'Language',
    'asr.hotword.langTip': 'ASR language only; hotwords are shared globally.',
    ...
    'asr.hotword.toggle.title': 'Hotword pool is managed globally',
    'asr.hotword.toggle.on': 'POOL',
    ...
    'asr.hotword.confirmClear': 'Delete the {n} shown hotwords from the global pool?',
    'asr.hotword.deleted': 'Deleted',
    'asr.hotword.reloaded': 'Reloaded',
    'asr.hotword.poolManaged': 'Hotwords are managed in the global Triton pool.',
    'asr.hotword.poolError': 'Hotword pool error: {msg}',

    'asr.sync.active': 'Active',
    'asr.sync.paused': 'Paused',
    'asr.sync.poolActive': 'Pool active',
  ...
  const ZH = {
    ...
    'asr.hotword.title': '全局热词池',
    'asr.hotword.tip': '管理 final 段 ASR 使用的 Triton 全局热词池。',
    'asr.hotword.lang': '语言',
    'asr.hotword.langTip': '仅控制 ASR 输入语种；热词池全局共享。',
    ...
    'asr.hotword.toggle.title': '热词由全局池统一管理',
    'asr.hotword.toggle.on': '全局',
    ...
    'asr.hotword.confirmClear': '确定从全局池删除当前显示的 {n} 个热词？',
    'asr.hotword.deleted': '已删除',
    'asr.hotword.reloaded': '已重载',
    'asr.hotword.poolManaged': '热词由 Triton 全局池统一管理。',
    'asr.hotword.poolError': '热词池错误：{msg}',

    'asr.sync.active': '生效中',
    'asr.sync.paused': '已暂停',
    'asr.sync.poolActive': '全局池生效',
    'asr.sync.saving': '保存中',
